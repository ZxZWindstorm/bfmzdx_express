...
<style>
	.log_view image{width: 120upx !important; height: 120upx !important; border-radius: 50%; margin-right: 20upx;
						border: 10rpx solid #999999;}
		text{display: block; margin: 10upx 0; color: #999999;}
		.log_view{display: flex; align-items: center; padding: 0 30upx; align-content: center;
				height: 200upx;}
		.log_text text{font-size: 35upx;}
	.home{
		display: flex;
	...
	.noLog_button{
		font-size: 35upx; color: #FFFFFF; margin-bottom: 25upx;
	}
	.noLog_view button{
		border: none;
		font-size: 30upx; 
